...
import EditLocation from "../components/managerLocation/EditLocation";
import AddLocation from "../components/managerLocation/AddLocation";
import EditImageLocation from "../components/managerLocation/EditImageLocation";
  ...
  return (
    <div>
      <div className="page-header">
        <h2 className="page-header__title">Quản lý vị trí</h2>
